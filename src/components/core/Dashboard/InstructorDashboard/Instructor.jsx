  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        <div>
          {/* Top Row: Chart + Statistics */}
          <div className="my-4 flex flex-col lg:flex-row gap-4 h-auto lg:h-[450px]">
            ...
            {/* Total Statistics */}
            <div className="flex w-full lg:w-auto min-w-[250px] flex-col rounded-md bg-richblack-800 p-4 sm:p-6">
              <p className="text-lg font-bold text-richblack-5">Statistics</p>
              <div className="mt-4 flex flex-row lg:flex-col justify-between space-y-0 lg:space-y-4 gap-2 flex-wrap">
                <div>
              ...
              {courses.slice(0, 3).map((course) => (
                <div key={course._id} className="w-full">
                  ...
                  <div className="mt-3 w-full">
                    ...
                    <div className="mt-1 flex flex-wrap items-center justify-between gap-x-2 text-xs font-medium text-richblack-300">
