    ...
    <>
      <div className="relative w-full bg-richblack-800">
        <div className="mx-auto box-content px-4 lg:w-[1260px] 2xl:relative">
          <div className="mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]">
            ...
            <div className="z-30 my-5 flex flex-col justify-center gap-4 py-2 sm:py-5 text-base sm:text-lg text-richblack-5">
              <div>
              ...
              <div className="flex flex-wrap gap-3 sm:gap-5 text-xs sm:text-base">
      ...
      <div className="mx-auto box-content px-4 text-start text-richblack-5 lg:w-[1260px]">
        <div className="mx-auto max-w-maxContentTab lg:mx-0 xl:max-w-[810px]">
          <div className="my-8 border border-richblack-600 p-4 sm:p-8 rounded-md">
          ...
          <div className="max-w-[830px]">
            <div className="flex flex-col gap-3">
              <p className="text-[22px] sm:text-[28px] font-semibold">Course Content</p>
            ...
            <div className="mb-12 py-4">
              <p className="text-[22px] sm:text-[28px] font-semibold">Author</p>
